...
func (n *TableOptimizerHint) Restore(ctx *format.RestoreCtx) error {
	...
	switch n.HintName.L {
	case "mpp_1phase_agg", "mpp_2phase_agg", "mpp_tidb_agg", "mpp_scalar_agg", "debug", "hash_agg", "stream_agg", "agg_to_cop", "read_consistent_replica", "no_index_merge", "qb_name", "ignore_plan_cache", "limit_to_cop", "straight_join", "merge", "no_decorrelate":
		ctx.WritePlain(")")
		return nil
	}
	if n.QBName.L != "" {
