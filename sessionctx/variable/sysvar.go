...
var defaultSysVars = []*SysVar{
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBOptTiDBMPPNetworkFactorV2, Value: strconv.FormatFloat(DefOptNetworkFactorV2, 'f', -1, 64), Hidden: true, Type: TypeFloat, MinValue: 0, MaxValue: math.MaxUint64, SetSession: func(s *SessionVars, val string) error {
