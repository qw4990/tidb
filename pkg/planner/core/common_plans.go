...
func (e *Explain) prepareSchema() error {
	...
	case format == types.ExplainFormatRU && e.Analyze:
		fieldNames = []string{"section", "id", "component", "operatorClass", "actRows", "inputRows", "outputRows", "rowWidth", "rowWidthSource", "workRows", "workBytes", "unit", "count", "weight", "tidbRU", "source", "note"}
	case e.Explore:
