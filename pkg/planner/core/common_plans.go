...
func (e *Explain) getOperatorInfo(p base.Plan, id string) (estRows, estCost, costFormula, accessObject, operatorInfo string) {
	...
	return getOperatorInfo(e.SCtx(), p, id)
}

func getOperatorInfo(sctx planctx.PlanContext, p base.Plan, id string) (estRows, estCost, costFormula, accessObject, operatorInfo string) {
