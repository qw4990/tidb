...
func costWeights(sctx sessionctx.Context, costs map[string]float64) string {
	...
	for k, v := range costs {
		...
		case variable.TiDBOptCopHashTableFactorV2:
			factor = sctx.GetSessionVars().GetCopHashTableFactor()
		...
		case variable.TiDBOptTiDBMPPNetworkFactorV2:
			factor = sctx.GetSessionVars().GetTiDBMPPNetworkFactor()
		case variable.TiDBOptTiFlashMPPNetworkFactorV2:
			factor = sctx.GetSessionVars().GetTiFlashMPPNetworkFactor()
		...
		case variable.TiDBOptCopMemoryFactorV2:
			factor = sctx.GetSessionVars().GetCopMemoryFactor()
		case variable.TiDBOptTiFlashMemoryFactorV2:
			factor = sctx.GetSessionVars().GetTiFlashMemoryFactor()
	...
	for _, k := range []string{
		...
		variable.TiDBOptTiDBMPPNetworkFactorV2,
		variable.TiDBOptTiFlashMPPNetworkFactorV2,
		...
		variable.TiDBOptCopMemoryFactorV2,
		variable.TiDBOptTiFlashMemoryFactorV2,
